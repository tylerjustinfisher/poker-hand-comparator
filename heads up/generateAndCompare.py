...
def compareAndPrint(cards): # Take in the string, parse it, evaluate the hands, and print output (just once)
...
print "hand: " + hand + "  (cards alone: " + hand[0] + hand[2] + " " + hand[5] + hand[7] + " " + hand[10] + hand[12] + hand[14] + hand[16] + hand[18] + ")"
compareAndPrint(hand)
